In this repository are retro handheld overlays for devices with a resolution of 1280x960. There are versions for both integer and non-integer scaling, as well as with and without an inner shadow. They should be pixel-precise when using Retroarch.

Note these are border overlays only, with no LCD grid or anything like that. Use your favorite LCD shader in addition to these to dial in your desired final appearance. I'd also suggest changing the overlay brightness in Retroarch to your desired preference.
